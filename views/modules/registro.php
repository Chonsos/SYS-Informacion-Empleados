...
if (isset($_SESSION)) {
	if (!$_SESSION["adminActivo"]) {
		echo '<script>
                window.location.href = "violacionRegistroUsuarios";
              </script>';
		exit();
	}
} 
...
<body class="bg-theme bg-theme1">
	...
	<div id="wrapper">
		...
		<div id="wrapper">
			...
			<div class="formRegistro card card-authentication1 mx-auto my-4">
				<div class="card-body">
						...
						<form method="post">
							<div class="form-group">
								<div class="position-relative has-icon-right">
									<input type="text" id="exampleInputName" name="nombre" class="form-control input-shadow usernameValidation" placeholder="Cree su nombre de usuario">
							...
							<div class="form-group">
								<div class="position-relative has-icon-right">
									<input type="text" id="exampleInputEmailId" name="email" class="form-control input-shadow emailValidation" placeholder="Cree su correo electronico">
									<div class="form-control-position">
							...
							<div class="form-group">
								<div class="position-relative has-icon-right">
									<input type="password" name="password" class="form-control input-shadow" placeholder="Cree su contraseña">
									<div class="form-control-position">
										<i class="icon-lock"></i>
									</div>
								</div>
